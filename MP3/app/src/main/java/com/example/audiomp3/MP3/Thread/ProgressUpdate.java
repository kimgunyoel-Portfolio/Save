package com.example.audiomp3.MP3.Thread;
...
public class ProgressUpdate extends Thread{
     ...
     */
    public ProgressUpdate(AppCompatActivity appCompatActivity, MediaPlayer mediaPlayer, SeekBar seekBar, int position){
            ...
            try {
                ...
                if(mediaPlayer!=null){                                         //!< 미디어플레이어가 null값이 아닐떄
                    try{
                        ...
                        System.out.println("포지션값쓰레드 : " + posision);
                    }
                    catch (Exception e){
