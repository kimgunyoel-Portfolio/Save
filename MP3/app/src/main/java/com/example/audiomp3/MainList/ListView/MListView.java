...
import com.example.audiomp3.MP3.Activity.InMusicActivity;
...
public class MListView {
    ...
    public void setMListView(){
        ...
        Cursor cursor = aMListView.getContentResolver().query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI,      //!< 위에 음악정보 배열을 cursor 형태로 저장
        ...
        ListView listView = (ListView)aMListView.findViewById(R.id.myPLst);         //!< 리스트뷰 선언
